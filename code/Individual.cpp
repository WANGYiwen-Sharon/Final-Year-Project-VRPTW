...
Individual::Individual(Params* params, std::string solutionStr) : params(params), isFeasible(false), biasedFitness(0)
{
    ...
    // initialize weighted vectors, consider the number of objectives is 2.
    weight_vector   = std::vector<double>(2, 0);
    // initialize the neighbors, consider the number of objectives is 20.
    neighbor = std::vector <int> (20);
}
